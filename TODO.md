...
| CallawaySantAnna survey + covariates: DRDID panel nuisance-estimation IF corrections not implemented for any method. Currently gated with NotImplementedError. No-covariate survey works for all methods. | `staggered.py` | #233 | Medium |
